...
if __name__ == "__main__":
    ...
    try:
        bot.set_bot_commands([
            ...
            BotCommand("vplay",   "✧ ᴘʟᴀʏ ᴀ sᴏɴɢ ᴡɪᴛʜ ᴠɪᴅᴇᴏ ✧"),
            BotCommand("pause",  "✧ ᴘᴀᴜsᴇ ᴘʟᴀʏʙᴀᴄᴋ ✧"),
            BotCommand("resume", "✧ ʀᴇsᴜᴍᴇ ᴘʟᴀʏʙᴀᴄᴋ ✧"),
            BotCommand("skip",   "✧ sᴋɪᴘ sᴏɴɢ ✧"),
            BotCommand("stop",   "✧ sᴛᴏᴘ & ᴄʟᴇᴀʀ ✧"),
            BotCommand("tagall",   "✧ ᴍᴇɴᴛɪᴏɴ ᴇᴠᴇʀʏᴏɴᴇ ɪɴ ɢʀᴏᴜᴘ ✧") 
            BotCommand("canceltag",   "✧ sᴛᴏᴘ ᴍᴇɴᴛɪᴏɴɪɴɢ ᴇᴠᴇʀʏᴏɴᴇ ɪɴ ɢʀᴏᴜᴘ ✧"),
            BotCommand("id",   "✧ ɢᴇᴛ ᴀɴʏ ᴜsᴇʀ ɪᴅ ✧"),
        ])
